...
def build_modern_menu():
    # Modern, super-aligned, color-rich menu using rich.Table
    table = Table(
        title="[bold red]═════════ BOTNET C2 MAIN MENU ═════════[/bold red]",
        show_header=False,
        box=None,
        expand=True,
        padding=(0, 2),
    ...
    # Add menu options in two columns, super-aligned
    menu_rows = [
        ("[bold bright_cyan]1[/]. [white]Cloudflare Bypass", "[bold bright_cyan]2[/]. [white]FiveM Tester"),
        ("[bold bright_cyan]3[/]. [white]Layer4 Tester",      "[bold bright_cyan]4[/]. [white]Layer7 Tester"),
        ("[bold bright_cyan]5[/]. [white]Minecraft Tester",   "[bold bright_cyan]6[/]. [white]WAF Bypass"),
        ("[bold bright_cyan]7[/]. [white]Exit",               ""),
    ]
...
def show_menu():
    ddos_animation(cycles=1, delay=0.07)
    animated_banner(main_ascii_art, delay=0.0003)
    print()
    # Modern menu panel
    menu_panel = Panel(
        Align.center(build_modern_menu(), vertical="middle"),
        border_style="bold red",
        padding=(1, 4),
        title="[bold red]Selecteaza o optiune[/bold red]",
        subtitle="[bold bright_black]by @root[/bold bright_black]",
        width=70
    )
